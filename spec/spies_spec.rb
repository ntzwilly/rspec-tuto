RSpec.describe 'spies' do
  ...
  it 'confirms that a method have been received' do
    animal.eat_food
  ...
  it 'retains functionalities of a regular double' do
    animal.eat_food
    animal.eat_food
    ...
    expect(animal).to have_received(:eat_food).at_least(1).times.with('sushi')
